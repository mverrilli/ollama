...
// forceDisableFusedOutliers is a test-only toggle that will force outlier-
// active managers onto the slow DequantK + stock FA path once the fused
// kernel is debugged — enabling an A/B equivalence comparison between the
// two paths. Never set in production.
var forceDisableFusedOutliers bool
